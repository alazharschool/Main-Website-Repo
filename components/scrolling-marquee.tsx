  ...
  return (
    <div className="w-full overflow-hidden py-2 bg-gradient-to-r from-[#f8f3eb] via-[#fff7e0] to-[#f8f3eb] border-y border-yellow-400">
      <div className="flex items-center gap-4 w-full">
        ...
        >
          <Image src="/images/quran-logo.jpg" alt="Quran Logo" width={40} height={40} className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10" style={{ objectFit: 'contain', display: 'inline-block', verticalAlign: 'middle' }} />
        ...
        <div className="relative flex-1 overflow-hidden marquee-container">
          <div className="marquee flex gap-10 sm:gap-14" style={{ animation: 'marquee 18s linear infinite' }}>
            {marqueeItems.map((item, idx) => (
              ...
              >
                <Image src="/images/LOGOMMM.png" alt="logo" width={44} height={44} className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 inline-block" style={{ marginRight: '10px', verticalAlign: 'middle' }} />
                {item}
